...
class FundraiserController extends Controller
{
    ...
    public function update(Request $request, Fundraiser $fundraiser)
    {
        ...
        return redirect()->route('admin.fundraisers.index')->with('success', 'Fundraiser approved successfully');
    }
    ...
    public function destroy(Fundraiser $fundraiser)
    {
        ...
        try {
            $fundraiser->delete();
            DB::commit();
            return redirect()->route('admin.fundraisers.index')->with('success', 'Fundraiser deleted successfully');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->route('admin.fundraisers.index')->with('error', 'Fundraiser deleted failed');
        }
    }
}
