            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-10">    
                    ...
                    {{-- <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{ $fundraisingWithdrawal->swift_code }}</h3>
                    </div> --}}
                </div>
                <hr class="my-5">
                ...
                @else
                <hr class="my-5">
                <form action="{{ route('admin.fundraising_withdrawals.update', $fundraisingWithdrawal->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
