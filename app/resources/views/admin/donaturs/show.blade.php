        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-16">
                    ...
                    <div>
                        <img src="{{ Storage::url($donatur->fundraising->thumbnail) }}" alt="" class="rounded-2xl object-cover w-[300px] h-[300px] mb-3">
                ...
                @if (!$donatur->is_paid)
                <hr class="my-5">
                <form action="{{ route('admin.donaturs.update', $donatur->id) }}" method="POST">
                    @csrf
                    @method('PUT')
