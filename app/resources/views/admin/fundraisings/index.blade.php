            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-y-3 ">
                    <div class="flex flex-row items-center gap-x-4 w-full md:w-1/3">
                        <img src="{{ Storage::url($fundraising->fundraiser->user->avatar) }}" alt="" class="rounded-2xl object-cover w-[90px] h-[90px]">
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.fundraisings.show', $fundraising->id) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            View Details
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center justify-center">
                    <h3 class="text-indigo-950 text-xl font-bold">No Fundraising</h3>
                    <p class="text-slate-500 text-base">No Fundraising found</p>
                </div>
                @endforelse
